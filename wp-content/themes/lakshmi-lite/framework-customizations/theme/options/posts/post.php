...
$options = array(
	'general' => array(
		...
		'options' => array(	
			...
			'lsi_video_format_source'	=> array(
				'label' => __( 'Video Source', 'lakshmi-lite'),
				'type' => 'short-select',
				'value' => 'youtube',
				'choices' => array(
					'youtube' => 'Youtube',
				...
				'desc'  => __( 'Youtube or Vimeo.', 'lakshmi-lite'),
			),	
			'lsi_video_format'	=> array(
				'label' => __( 'Video ID', 'lakshmi-lite'),
				'type'  => 'text',
				'value' => '',
				'desc'  => __( 'Add the Youtube or Vimeo ID.', 'lakshmi-lite'),
			),
			'lsi_audio_format'	=> array(
				'label' => __( 'Audio (Audio Format Only)', 'lakshmi-lite'),
				'type'  => 'text',
				'value' => '',
				'desc'  => __( 'Add the Soundcloud ID of Your audio.', 'lakshmi-lite'),
			),
